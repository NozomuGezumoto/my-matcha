...
function wrapFetchWithProgress(fetch) {
    return function fetchWithProgress(url, init) {
        return fetch(url, init).then((response)=>{
            ...
            // Abort if no response (e.g. fetch returned undefined), no `onProgress`, the request failed, or there is no response body
            if (!response || !onProgress || !response.ok || !response.body) {
                return response;
            }
